...
<body class="backendFont">
    ...
    <header class="superadminHeader bg-dark text-white py-3">
  ...
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="#"><img width="200px" height="auto" class="logo" src="<?= base_url('frontend/images/logo.png'); ?>" alt="Company Logo"></a>
    ...
    <div class="" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle superadmintoggleeee" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu"> 
             <li><a class="dropdown-item" href="<?= base_url('superadmin/profile'); ?>">Profile</a></li>
                        ...
                        <li><a class="dropdown-item" href="<?= base_url('maintenance-control'); ?>">Maintenance Mode</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
