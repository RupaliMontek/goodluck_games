<!-- superadmin admin_balance_amount_extend_request popup -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><?php echo $request_details->first_name." ".$request_details->last_name; ?> (Admin) sent a balance request of<br><b class="statuss"><span class="forrepiesSign">&#8377;</span> <?= $request_details->balance_request_amt; ?></b></p>
      ...
      <div class="modal-footer">        
        <button class="submitPopupYell" type="submit">Submit</button>
      </div>
    </form>
    </div>
  </div>
