...
<a href="<?= base_url('admin/send_balance_return_super_admin'); ?>" class="btn btn-primary">Send Money Return to Superadmin</a>  

     <h1>Admin Balance Return</h1>
           ...
           <table  class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(empty($admin->superadmin_accept_status)){ ?> <label style="color:orange;">Pending</label> <?php 
                        }
                        elseif($admin->superadmin_accept_status==1)
                        {
                        ?> 
                        <label style="color:green;">Approve</label>  
                        <?php } 
                        elseif($admin->superadmin_accept_status==2)
                        {
                        ?> <label style="color:red;">Disapprove</label>  
                        <?php } 
                        ?>
                    </td>
