<div id="admin_balance_amount_return_request_withdraw" class="modal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <?php echo form_open('admin/change_status_admin_send_return_balance_amount_withdraw'); ?>
      <div class="modal-header">
        <h5 class="modal-title">Return Balance Request From Admin <?php echo $request_details->first_name." ".$request_details->last_name; ?></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p><?php echo $request_details->first_name." ".$request_details->last_name; ?> Admin Send Request Return Balance. Amount is <b><?= $request_details->balance_request_amt; ?></b></p>
