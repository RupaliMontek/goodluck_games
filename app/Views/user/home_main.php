...
<div class="forspinner">     
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="forTopFirstButtons">
                    ...
                    <input class="form-control" type="hidden" name="numberss" id="numberss">
                     ...
                     <div class="forbtnnn">
                        <h6>Last 10 Data</h6>
                        <button type="button" class="btn nopadBtnn">
                       <!-- Horizontal Layout -->
       <ul class="horizontal-list listForCap" id="last_10_reuslts">
        <?php
            $count = 0; 
            foreach ($last_ten_results as $result): 
                if($result["mode_set"]=='jackpot_2x' || $result["mode_set"] =='jackpot')
                {
                     $jackpot_class = "jackpot_class";
                }
                else
                {
                    $jackpot_class = "";
        ...
        ?>
            <li class="<?= $jackpot_class; ?>"><?php if($result["mode_set"]=='jackpot_2x' || $result["mode_set"] =='jackpot')
                {
                     echo '<img src="' . base_url("frontend/images/winnercap4.png") . '" alt="" width="80%" height="auto">';
                     $jackpot_class = "jackpot_class";
    ...
    <!--below button code is old button bakcup for I make display none for now -->
                    <button style="display:none;" type="button" class="btn">
                       <!-- Horizontal Layout -->
