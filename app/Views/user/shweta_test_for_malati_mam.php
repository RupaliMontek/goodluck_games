...
<head>
    ...
    <title>Play Game online</title>
     <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
     <link href="<?php echo base_url("frontend/NEWmydesignstyle.css");?>" rel="stylesheet">
    <link href="<?php echo base_url("frontend/ForMobileNew.css");?>" rel="stylesheet">
   
    
     <?php 
     if($theme == 'light_theme'){ ?>
        <link href="<?php echo base_url("frontend/NEWLightTheme.css"); ?>" rel="stylesheet">
    <?php }
    else
    { ?>
         <link href="<?php echo base_url("frontend/NEWDarkTheme.css");?>" rel="stylesheet">   
    <?php }
...
<div class="forspinner">     
    <div class="wrapper">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="forTopFirstButtons">
                    <div class="forbtnnn">
                        ...
                        <img class="lightThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/discoBtnNewLight.png");?>" alt="" />
                        <img class="darkThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/discoBtnDark.png");?>" alt="" />
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="forTopFirstButtons">
                    <div class="forbtnnn">
                        ...
                        <img class="lightThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/discoBtnNewLight.png");?>" alt="" />
                        <img class="darkThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/discoBtnDark.png");?>" alt="" />
                    <button id="counter_button" type="button" class="btn"><div id="counter"></div></button>
                    </div>
                    </div>
     ...
     <!--below button code is for jackpot cap bakcup for I make display none for now -->
...
<!--shweta sound change start-->        
<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12">

        <audio id="radio-sound" src="<?php echo base_url("frontend/game_audio/click558.mp3"); ?>" preload="auto"></audio>
        <!-- Add more audio elements for each sound if needed -->
        
        <div class="forCircledNumberss">
            <div class="forCirclebtnnn">
                <div class="radio-button">
                    <div class="radiolabelOuter">
                         <div class="radiolabel">  
                         <img class="frNoMobileeee" src="<?php echo base_url("frontend/images/daller.png"); ?>" alt="" width="100%" height="auto">
        ...
        radio.addEventListener('click', function() {
            ...
            switch (this.value) {
                ...
                case '50':
                    soundId = 'radio-sound';
                    break;
                // Add cases for other values if you want different sounds
                default:
                    soundId = 'radio-sound'; // Default sound
            }
            document.getElementById(soundId).play();
        });
    });
</script>
<!--shweta sound change end-->
        
        <div class="forWholeBottomPart">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 frusernameHedddd">
                ...
                <div class="forbettt"> 
                    <div class="forbetttbtnnn">
                        <div class="betttbtnnnouterdiv">
                    <img class="lightThemeColorrr" src="<?php echo base_url("frontend/images/redbtnnnNewLight.png"); ?>" alt="" width="100%" height="auto">
                    <img class="darkThemeColorrr" src="<?php echo base_url("frontend/images/redbtnnnDark.png"); ?>" alt="" width="100%" height="auto">
                    ...
                    <!--<button  type="button" class="btn" onclick="betok_new_func()" id="betok_new">betoksayali</button>-->
                    </div>
                    ...
                    <div class="betttbtnnnouterdivforsmallbtnn">
                        <img class="lightThemeColorrr" src="<?php echo base_url("frontend/images/redbtnnnNewLightsmall.png"); ?>" alt="" width="100%" height="auto">
                         <img class="darkThemeColorrr" src="<?php echo base_url("frontend/images/redbtnnnDarksmall.png"); ?>" alt="" width="100%" height="auto">
                    <button type="button" class="btn frbetokk" id="betok">Bet Ok</button>
                    </div>
                    
                    <div class="betttbtnnnouterdivforsmallbtnn lastttprevbtn">
                        <img class="lightThemeColorrr" src="<?php echo base_url("frontend/images/redbtnnnNewLightsmall.png"); ?>" alt="" width="100%" height="auto">
                         <img class="darkThemeColorrr" src="<?php echo base_url("frontend/images/redbtnnnDarksmall.png"); ?>" alt="" width="100%" height="auto">
                    <button type="button" onclick="bet_previous()" class="btn frprevokk" id="prevok">Prev</button>
                    </div>
                    </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 finalValueOuterDiv">
                <div id="final-value">
                     <img class="lightThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/valubtnNewLight.png"); ?>" alt="" width="100%" height="auto">
                        <img class="darkThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/valubtnDark.png"); ?>" alt="" width="100%" height="auto">
                <p>value</p>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="forBottompartt">
                    ...
                    <button type="button" class="btn" id="totalamt">0</button>
                     ...
                     <div class="frH6outerr">
                    <img src="<?php echo base_url("frontend/images/discoBtn.png"); ?>" alt="" width="100%" height="auto">   
...
let myChart = new Chart(wheel, {
  ...
  data: {
    // Labels (values which are to be displayed on chart)
     labels: [9, 8, 7, 6, 5, 4, 3, 2, 1, 0], // Labels from 0 to 9
 ...
 function easeOut(t) {
        ...
        $(document).ready(function() {
            ...
            for (let i = 0; i < 10; i++) {
                ...
                <div class="buttonouterdiv">
                <img class="lightThemeColorrr" width="100%" height="auto" src="https://goodluck.montekservices.in/frontend/images/decoBtnn.png" alt="">
                        <img class="darkThemeColorrr" width="100%" height="auto" src="https://goodluck.montekservices.in/frontend/images/decoBtnn.png" alt="">
                                    <span class="showNobtn" id="showNobtn${i}">0</span>
                                    </div>
                                    <div class="buttonouterdivShowbtn">
                                     <button id="myButton${i}" class="btn number-btn" disabled>
                                    <span class="forActiveNumberrr">${i}</span>
                                     <img class="lightThemeColorrr" width="100%" height="auto" src="https://goodluck.montekservices.in/frontend/images/goldbtn.png" alt="">
                        <img class="darkThemeColorrr" width="100%" height="auto" src="https://goodluck.montekservices.in/frontend/images/goldbtn.png" alt="">
                        <img class="forActiveGreenColorr" width="100%" height="auto" src="https://goodluck.montekservices.in/frontend/images/greenbtn.png" alt="">
...
function playSound() {
    buttonSound.currentTime = 0; // Reset to start if already playing
    buttonSound.play();
}

function incrementValue(index) {
    // alert('value_increment');
    ///////////////////sayali
...
function get_counter_timer_universal() 
{
    ...
    // Fetch time from the server and sync timer
    $.ajax({
        ...
        success: function(data) {
            ...
            if (timeStr !== '') {
                ...
                totalSeconds -= 10; // Adjust by 10 seconds if needed
                ...
                // Handle case when time reaches zero
                if (timeStr === '00:00') {
                    newMinutes = 0;
                    newSeconds = 50;
                }
                ...
                // Check if numbers are not zero and time matches
                     ...
                     number5 !== 0 || number6 !== 0 || number7 !== 0 || number8 !== 0 || number9 !== 0)) 
                {
                    ...
                    // Clear active buttons if necessary
            ...
            // Check for spinner calls at specific times
...
/*old function 10 oct 2024 backup*/
/*function get_counter_timer_universal() 
{
    var number1 = $("#number1").val();
    var number2 = $("#number2").val();
    ...
    $.ajax({
        ...
        data: {},
        success: function(data) {
            // console.log("Time is k "+data.start_time);
            //           console.log("Time is k "+data.display_time );
             if(data.start_time=='120')
             {
                 var data = (data.display_time).replace(/"/g, '');
                    $("#counter").html(data);
        console.log("Time is "+data);
                    //  console.log("Time is "+data.display_time );
                    ...
                    if (timeStr !== '') {
                        ...
                        var formattedSeconds = newSeconds.toString().padStart(2, '0');
                        const newTimeStr = formattedMinutes + ':' + formattedSeconds;
                        if (data === newTimeStr && (number0 !== 0 || number1 !== 0 || number2 !== 0 || number3 !== 0 || number4 !== 0 || number5 !== 0 || number6 !== 0 || number7 !== 0 || number8 !== 0 || number9 !== 0)) 
                        {
                            if(!bet && !takebtnClicked)
                            {
                               $("#take-btn").trigger('click');
...
function triggerCancel() {
            $('#onebetcancel').click(); // Programmatically trigger the click event
        }
...
function spinner_spin() 
{
    ...
    // setTimeout(function() {
        $('#prevok').hide();
    // }, 1000);
    finalValue.innerHTML = `<img class="lightThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/valubtnNewLight.png"); ?>" alt="" width="100%" height="auto">
                        <img class="darkThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/valubtnDark.png"); ?>" alt="" width="100%" height="auto"><p>Spinning...</p>`;
    var showNobtn1 = parseInt(document.getElementById('showNobtn1').innerText);
    $("#number1").val(showNobtn1);
    var number1 = $("#number1").val();
    var showNobtn2 = parseInt(document.getElementById('showNobtn2').innerText);
    ...
    $.ajax({
        ...
        type: "GET",
        success: function(data) {
            var main_values = [1, 2, 3, 4, 5, 6, 7, 8, 9, 0];
            let targetValue = 0;
            var parsedObject = JSON.parse(data);
            var valuesString = parsedObject.values;
            var valuesArray = valuesString.split(',');
            var savedNumbers = valuesArray.map(Number);
            var mode_set = parsedObject.mode;
            var remainingNumbers = main_values.filter(number => !savedNumbers.includes(number));
             if (mode_set !== 'jackpot_2x' && mode_set !== 'jackpot') {
                if (remainingNumbers.length === 0) {
                    //console.log("All numbers are saved. No numbers to spin.");
                    return;
            ...
            let spinDuration = 4000; // Fixed duration to 7 seconds
            let intervalDuration = 40; // Interval duration for smoother progress
            let totalSteps = spinDuration / intervalDuration;
            let rotations = 4; // Number of full rotations
            ...
            let rotationInterval = window.setInterval(() => {
                ...
                if (step >= totalSteps) {
                    ...
                    // Set final position directly at the end of 7 seconds
                    myChart.options.rotation = targetAngle;
                    myChart.update();
                    finalValue.innerHTML = `<img class="lightThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/valubtnNewLight.png"); ?>" alt="" width="100%" height="auto">
                        <img class="darkThemeColorrr" width="100%" height="auto" src="<?php echo base_url("frontend/images/valubtnDark.png"); ?>" alt="" width="100%" height="auto"><p>Value: ${targetValue}</p>`;
                    spinBtn.disabled = false;
                    ...
                    // 6/9 shweta start
                    if ((mode_set === 'jackpot_2x') && winnerValue !== 0) {
                        let targetButton = document.getElementById('myButton' + targetValue);
    ...
    // Add the active class to the target button if it exists
    if (targetButton) {
        targetButton.classList.add('active'); // Add active class to the specific button
    }
                    }
                    // 6/9 shweta end
                   
                    var winnerButton = document.getElementById('winnerBtn');
                    ...
                    if (showNobtnElement) 
                    {
                        var showNobtnValue = parseInt(showNobtnElement.trim());
                        if (!isNaN(showNobtnValue)) 
                        {
                            if (mode_set !== 'jackpot_2x') 
                            {
                                winnerValue = showNobtnValue * 9;
                            } 
                            else 
                        ...
                        { 
                            ...
                            // shweta changes start
                             for (let i = 0; i <= 9; i++) {
                                let showNobtnId = 'number' + i;
                                $("#" + showNobtnId).val(0); // Reset the input value to 0
                                document.getElementById('showNobtn' + i).innerText = '0'; // Reset the displayed value to 0
                                // 20 sep added shweta
                                $('#totalamt').text('0'); // If totalamt is a span/div
                                $('#totalamt').val(0);
                                
                                // 20 sept end shweta
                            }
                            // shweta new changes start
                            $('.forBottomCounterr button.active').each(function() {
                            $(this).removeClass('active');
                        });
                        // shweta new end
                                ///////////sayali
                            //      $("#betok").hide();...........commented by shweta
                            //     $("#prevok").show();
                            //   bet_previous();
                        // shweta changes end
                         $('#totalamt').text('0'); // If totalamt is a span/div
                        ...
                        else
                        {
                            ...
                            takebtnClicked = false;
                            $('#take-btn').prop('disabled', false);
                            $('#take-btn').addClass('btn glow');
                            // $("#betok").hide();..........commented by shweta
                            //     $("#prevok").show();bet_previous();
                        }
                        if (winnerValue !== 0) 
                        {
                            var winnerBtn = document.getElementById("winnerBtn");
                   ...
                   // console.log("Number saved successfully:", targetValue);
                    $('#mycurrentno').val(targetValue);
                    $('#mycurrentno_mode').val(mode_set);
                    $.ajax({
                        url: base_url + 'user/saveStoppedNumber',
                        type: 'POST',
                        data: { stoppedNumber: targetValue,mode_set:mode_set,user_id:user_id },
                        success: function(response) {
                            // console.log("Number saved successfully:", user_id);
...
/////////////sayali
// $('#prevok').on('click', function()............commented by shweta 20 sep
// {
//     bet_previous();
//      $("#prevok").show();
//      $("#betok").hide();
       
// });............commented by shweta 20 sep
// function prevbit(id)
// {
//     console.log(id);
//     if()
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < Math.min(10, data.length); i++) {
                ...
                // Determine the class based on mode_set
                var jackpot_class = item.mode_set === 'jackpot_2x' ? 'jackpot2_class' : '';
                
                // Create the list item with the appropriate class
...
{ 
    // console.log("Collection Function Called "+loss_amount_collect);
...
{   
    ...
    var remainingTime = $('#counter').text();
    remainingTime = parseInt(remainingTime.split(':')[0]) * 120 + parseInt(remainingTime.split(':')[1]);
    //console.log(takebtnClicked+" Bet Clicked Button Status");
    // console.log(remainingTime);
    // console.log(remainingTime+" Remaning Time Is "+spinnerCalled +" Button Dispable Flag "+buttons_disable);
    ...
    {   
        //console.log("If");
        /*if(!takebtnClicked ) comment by jaywant
        {   
            //console.log("Button Is Disable");
            console.log("TakeButton Is Disable");
             $('#take-btn').prop('disabled', true);
        }*/
       disableButtons();
       //isBetOkClicked = false;
...
function cancelBet() {
    ...
    // if (selectedButtonIndex === null || selectedButtonIndex === undefined) {
    //     alert("No bet selected to cancel.");
    //     return;
    // }
    
    // let spanId = `#showNobtn${1}`;
    ...
    let totalAmt = localStorage.getItem('totalamt');
    // If you need the value as a number, you may need to convert it from a string
...
document.getElementById('logoutBtn').addEventListener('click', function(event) {
    ...
    if (confirm("Do you want to exit the game?")) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                window.location.href = base_url + 'logohome'; // Redirect even if there was an error
            }
        });
    }
});
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Array of all audio elements to manage
        var allSounds = [
            tickSound,
        ...
        // Function to start playing the ticking sound
        function startSound() {
...
<!--shweta sound new end-->

<!--6/9 shweta start-->
<script>
let isAudioPlaying = true; // Variable to keep track of the audio status
...
function toggleAudio() {
    ...
    // Loop through each audio element to mute/unmute
    audios.forEach(audio => {
        if (audio) {
            audio.muted = isAudioPlaying; // Mute/unmute based on the current state
        } else {
    ...
    updateAudioIcon(); // Update the button text based on the current state
...
// Set the initial icon based on the default state
updateAudioIcon();
...
//   console.log(isBetOkClicked);
   var mybutoncliekced=isBetOkClicked;
    var betButtons = {}; // Object to store bet button values
    
    // Loop through the buttons with IDs like #showNobtn0, #showNobtn1, etc.
    for (let i = 0; i < 10; i++) {
        var buttonValue = $(`#showNobtn${i}`).text() || '0';
        betButtons[`showNobtn${i}`] = buttonValue; // Store value in the object
    }
    var main_score = $("#main_score").text();
    // for (let i = 0; i < 10; i++) {
    //                 $(`#showNobtn${i}`).text(data[`showNobtn${i}`] || '0');
    //                 console.log($(`#showNobtn${i}`).text(data[`showNobtn${i}`] || '0'));
    //             }
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            //    console.log('Received data:', main_score);
           },
        error: function(xhr, status, error) {
           // console.log('Error:', error);
            // Show the Prev button again in case of an error
            $('#prevok').show();
        }
    });
}
