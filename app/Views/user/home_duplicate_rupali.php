...
$(document).ready(function()
{
 ...
 const EnableButtonsdd = () => 
    {
        $('#betok,#betcancel,#onebetcancel,#myButton1,#myButton2,#myButton3,#myButton4,#myButton5,#myButton6, #myButton7,myButton8,#myButton9,#myButton0').prop('disabled', false);
    };
...
///javascipt for when click on Bet Ok disabled all buttons    
/*    document.getElementById('betok').addEventListener('click', function() {
    this.disabled = true;
    this.classList.add('inactive');
    console.log('Button 1 clicked and now inactive.');
});
*/
//end 
