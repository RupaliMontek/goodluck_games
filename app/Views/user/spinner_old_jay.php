...
// Shweta sound end
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            let spinDuration = 1000; // Increased duration for slower spin (3 seconds)
            let intervalDuration = 25; // Decreased interval for smoother progress
...
function enableButtons()
{
    ...
    else if ((number1 != 0 || number2 != 0 || number3 != 0 || number4 != 0 || number5 != 0 || number6 != 0 || number7 != 0 || number8 != 0 || number9 != 0 || number0 != 0) && button_increment)
    {
        ...
        //console.log("ELSE IF");
        //  prevbit(1);
         $("#prevok").show().delay(10000).hide();
       
        $("#betok").hide().delay(30000).show();;
