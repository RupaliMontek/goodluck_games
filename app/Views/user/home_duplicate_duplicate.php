...
{   spinnerCalled  = false;
   //btn_disable    = false;
    $('#totalamt,#take-btn,#betcancel,#onebetcancel,#myButton1,#myButton2,#myButton3,#myButton4,#myButton5,#myButton6, #myButton7,myButton8,#myButton9,#myButton0,#logoutBtn').prop('disabled', true);
    var spin_btn = document.getElementById("spin-btn");
    spin_btn.disabled = true;
        ...
        $.ajax({
			...
			success: function(data)
			{
                ...
                if(data=='01:00' && !spinnerCalled)
                {
                    ...
                    if( number1!==0||number2!==0||number3!==0||number4!==0||number5!==0||number6!==0||number7!==0||number8!==0||number9!==0)
                    {
                        btn_disable   = true;
                    } 
                    else
...
$(document).ready(function()
{
    ...
    {
        $('#betcancel,#onebetcancel,#myButton1,#myButton2,#myButton3,#myButton4,#myButton5,#myButton6, #myButton7,myButton8,#myButton9,#myButton0').prop('disabled', true);
    };
