...
function incrementValue(index) {
    ...
    ////////code sayali for cancel specific bit-27 august 2024 ------start 
...
{
    var new_specific_value=$("#myhidespcific").val().trim();
...
function cancelBet() {
//   if (new_specific_value === null || new_specific_value === undefined) {
...
//     }
    ...
    console.log(new_total_amt);
    ////Reset the button value
    $(spanId).text(0);
     localStorage.setItem(spanId, 0);
    // localStorage.setItem('totalamt', new_total_amt);
