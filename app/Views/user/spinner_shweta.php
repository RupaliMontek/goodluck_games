            ...
            function updateTotalAmount() 
{
    ...
    //console.log(totalamt);
            ...
            // added by shweta 18 sept
            
            // Function to update localStorage
            function updateLocalStorage(buttonId, value) {
            ...
            //     $(`#myButton${i}`).one('click', function() {
            //         let currentValue = parseInt($(`#showNobtn${i}`).text());
            //         let newValue = currentValue + 1; // Increment value by 1
            //         $(`#showNobtn${i}`).text(newValue); // Update display
            //         updateLocalStorage($(this).attr('id'), newValue); // Store in localStorage
            //     });
            // }
            
            // // Load stored values from localStorage when the page loads
            // for (let i = 0; i < 10; i++) {
            //     let storedValue = localStorage.getItem(`myButton${i}`);
            //     if (storedValue !== null) {
