...
$(document).ready(function()
{
    ...
    {
        $.ajax({
            url: base_url+'user/get_universal_counter_timer_all', // The endpoint that returns the countdown timeget-number
            type: 'GET',
            dataType: 'json',
            success: function(data)
            {
...
function stopLongPress()
{
    ...
    {
        // console.log(longPressIntervalId);
...
function incrementValue(number) 
{
    ...
    // function showNobtn(elemente)
    // {
        
    //  console.log(elemente);
    //  var elements = document.querySelectorAll('.showNobtn');
    ...
    //         // Loop through the NodeList and push the IDs to the array
    //         elements.forEach(function(element) {
    //             console.log(elements);
    //             ids.push(element.id);
    //         });

    //         // Log the array of IDs to the console
    //         console.log(ids);
    //       }
