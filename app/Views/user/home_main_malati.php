...
<head>
    ...
    <link href="<?php echo base_url("frontend/NEWresponsiveStyle.css");?>" rel="stylesheet">
      ...
      <div class="container">
       ...
       <div class="forWholeBottomPart">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div id="final-value">
                    <img class="lightThemeColorrr" src="<?php echo base_url("frontend/images/valubtnNewLight.png"); ?>" alt="" width="100%" height="auto">
                    <img class="darkThemeColorrr" src="<?php echo base_url("frontend/images/valubtnDark.png"); ?>" alt="" width="100%" height="auto">
                <p>value</p>
...
// Function to calculate font size in vw with min and max limits
        function getResponsiveFontSize() {
            const minFontSize = 30; // Minimum font size in px
            const maxFontSize = 120; // Maximum font size in px
            const fontSizeVw = window.innerWidth * 0.03; // 3vw
            return Math.min(Math.max(fontSizeVw, minFontSize), maxFontSize);
        }
    ...
    plugins: {
      ...
      // Display labels inside pie chart
                    datalabels: {
                        ...
                        font: { size: getResponsiveFontSize() }, // Initial font size
      },
    },
    rotation: 0,
  },
});
// Function to resize canvas and update chart font size
        function resizeCanvas() {
            wheel.width = window.innerWidth * 0.8; // Adjust width to 80% of window width
            wheel.height = window.innerHeight * 0.8; // Adjust height to 80% of window height
            myChart.options.plugins.datalabels.font.size = getResponsiveFontSize(); // Update font size
            myChart.resize(); // Resize chart
            myChart.update(); // Update chart to apply new settings
        }

        // Initial canvas resize and chart creation
        resizeCanvas();
        ...
        $(document).ready(function() {
            ...
            for (let i = 0; i < 10; i++) {
                let buttonHtml = `<div class="CounterrOuterrbtn">
                                    ...
                                    <img src="<?php echo base_url("frontend/images/decoBtnn.png"); ?>" alt="" width="100%" height="auto">
                                    <div class="buttonOuterdivvv">
                                    <img src="<?php echo base_url("frontend/images/goldbtn.png"); ?>" alt="" width="100%" height="auto">
