...
console.log(valuesArray); // Output: ['10', '8']
            
             

const filteredArray = main_values.filter(item => valuesArray.indexOf(item) === -1);
 const randomIndex = Math.floor(Math.random() * filteredArray.length);
console.log(filteredArray); const targetValue = filteredArray[randomIndex]; 
...
<style>
/* font for spinner numbers start here */
