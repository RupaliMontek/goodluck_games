...
<div class="container mt-3 frmobpaddingzeroo">
    <div class="row">
...
<form action="<?= base_url('superadmin/delete_records') ?>" method="post" onsubmit="return confirmDelete()">
                ...
                <div class="table-responsive mt-3"> 
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($list_admin_request_balance as $admin): ?>
                                <tr>
