  ...
  <div class="col-lg-12">
    <div class="card mb-4 mb-md-0">
      <div class="card-body">
        ...
        <span>
          <input id="current_wallet_amount" name="current_wallet_amount" type="text" class="form-control" readonly value="<?= htmlspecialchars($current_wallet_amount); ?>">
        </span>
        <hr>
        <h6>Add Extra Money</h6>
        <form method="post" action="<?= base_url('superadmin/add_money'); ?>">
          <div class="input-group mb-3">
            <input type="number" class="form-control" name="extra_money" placeholder="Enter amount">
