  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 style="display:none;" class="modal-title">Request Amount From Admin <?php echo $request_details->first_name." ".$request_details->last_name; ?></h5>
      ...
      <div class="modal-body">
        ...
        <p>request of amount <b><span class="forrepiesSign">&#8377;</span><?= $request_details->balance_request_amt; ?></b> sent by you. <?php echo $request_details->first_name." ".$request_details->last_name; ?></p>
